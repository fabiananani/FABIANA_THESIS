...
%% INPUT PARAMETERS
 ...
 % Costs and Efficencies 
    ...
    Const2 = Const1/HHV/eff_FC^2; %[kg/h/kJ]
...
% OPERATIONAL decision variables
    ...
    sizingprob.Constraints.PowerFC4               = P_FC <= S_FC_max * FC_On;
...
m_flow_H2_opt   = P_FC_opt./eff_FC./HHV.*3600 + P_FC_opt.*Const2*w_hours_opt*3600;
m_flow_H2_id    = P_FC_opt./eff_FC./HHV.*3600; 
