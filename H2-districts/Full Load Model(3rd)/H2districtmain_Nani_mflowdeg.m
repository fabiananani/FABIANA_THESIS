...
%% INPUT PARAMETERS
 ...
 % Costs and Efficencies 
    ...
    c_h2        = 3;                                     % cost of hydrogen [euro/kg]
...
% OPERATIONAL decision variables
    ...
    sizingprob.Constraints.massflow                  = m_flow_H2 == P_FC./eff_FC./LHV.*3600 + Const1.*cum_hours_active; 
...
m_flow_H2_opt   = solution.m_flow_H2;% [kg/h]
m_flow_H2_id   = P_FC_opt./eff_FC./LHV.*3600; % [kg/h]

figure 
plot(Time,m_flow_H2_opt)
