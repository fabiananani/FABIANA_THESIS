...
m_flow_H2_id    = P_FC_opt_2./eff_FC./LHV.*3600; 

etadeg_opt      = P_FC_opt_2./m_flow_H2_opt./LHV*3600; 

save('scenariocost2.mat', 'cost_inst_2', 'cost_imp_2', 'cost_exp_2', 'cost_maint_2', 'cost_tot_2');
save('MILP_MILPDEG2.mat', 'P_FC_opt_2');
...
%% INDICATORS 
CF= sum(P_FC_opt_2)/(S_FC_opt*nHours)*100;    % [%]
% energy indicators
...
SelectedWeekSummer_PLOT(linew,font,Time,startS,finishS,P_PV_opt,P_FC_opt_2,P_imp_opt,P_exp_opt,S_FC,SOC_opt,P_load,delta_On_opt)
SelectedWeekWinter_PLOT(linew,font,Time,startW,finishW,P_PV_opt,P_FC_opt_2,P_imp_opt,P_exp_opt,S_FC,SOC_opt,P_load,delta_On_opt)
