function [] =SelectedWeekAutumn_QPLOT(linew,font,Time,start,finish,P_th_FC_opt,P_th_HEX_out_opt,P_th_load,P_th_amb)
...
hold on 
% h4=area(tt,-P_th_amb(start:finish), 'FaceColor', 'r', 'FaceAlpha', 0.4, 'EdgeColor', 'none');
% hold on
% plot(tt,-P_th_amb(start:finish),'LineWidth',linew,'Color','r');
...
percA=sum(P_th_HEX_out_opt(start:finish))*100/sum(P_th_FC_opt(start:finish))
