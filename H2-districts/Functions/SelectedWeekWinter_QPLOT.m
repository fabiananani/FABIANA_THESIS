function [] =SelectedWeekWinter_QPLOT(linew,font,Time,start,finish,P_th_FC_opt,P_th_HEX_out_opt,P_th_load,P_th_amb)
...
percW=sum(P_th_HEX_out_opt(start:finish))*100/sum(P_th_FC_opt(start:finish))
