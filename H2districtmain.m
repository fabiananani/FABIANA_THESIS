...
%% INPUT PARAMETERS
 ...
 % Flag for electricity cost (true/false)
    ...
    eff_FC       = 0.51*HHV/LHV;                          % constant electrical efficency of FC  
    max_LT       = 40000;                                 % [h]
...
cost_inst_1       = evaluate(cost_inst, solution);                                 % kEUR/y
cost_imp_1        = evaluate(cost_imp, solution);                                  % kEUR/y
cost_maint_1      = evaluate(cost_maint, solution);                                % kEUR/y
...
m_flow_H2_opt   = P_FC_opt./eff_FC/HHV*3600; % [kg/h]
...
% movegui('center');
% Energy_SizeIndicators_PLOT(linew,font,Time,S_FC_matrix,P_FC_matrix,P_load,eff_FC,E_load,numCosts,c_h2)